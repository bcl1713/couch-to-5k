...
The system SHALL maintain secure user sessions using HTTP-only cookies or JWT
tokens, allowing users to remain logged in across page reloads and browser
restarts.
